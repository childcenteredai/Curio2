...
<Evaluation Criteria>
1. Start by checking if the child's response is *not a question* (e.g., an observation or statement), respond with '<no_question>'. If the child's response is not a question, you can ignore the rest of the evaluation criteria.
